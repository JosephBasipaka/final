...
class DunningSchedulerTest {
    ...
    //     overdueCustomers.add(new Customer(1L, "John", "john@gmail.com", null, null));
    //     overdueCustomers.add(new Customer(2L, "Joseph", "joseph@gmail.com", null, null));
    ...
    void testScheduleInitialReminder() {
        ...
        verify(dunningService, times(customers.size())).initiateDunning(any(Customer.class), any(Service.class), anyString());
    ...
    void testScheduleFinalNotice() {
        ...
        verify(dunningService, times(1)).findCustomersWithFinalNotice();
        verify(serviceService, times(customers.size())).findServiceForCustomer(any(Customer.class));
        verify(dunningService, times(customers.size())).initiateDunning(any(Customer.class), any(Service.class), anyString());
